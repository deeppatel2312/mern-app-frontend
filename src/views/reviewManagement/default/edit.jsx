    ...
    const loadReview = async () => {
        ...
        let results = await fetch(`${process.env.REACT_APP_API_URL}/api/admin-user/getRatingReviewById`, {
            ...
            .then((res) => {
                ...
                setIsLoading(false)
                setFetchedData(data)
                setActive(data.isActiveForProvider)
                ...
                <div className="w-full max-w-full flex-col items-center xl:max-w-[1120px] border border-gray-400 p-8 rounded-[8px] block">
                    ...
                    <div className="flex flex-wrap">
                        ...
                        <InputField
                            variant="auth"
                            extra="mb-3 w-80 mr-5"
                            label="Rating by provider to user"
                        ...
                        <InputField
                            variant="auth"
                            extra="mb-3 w-80 mr-5"
                            label="Review by provider to user"
                        ...
                        {/* <InputField
                            variant="auth"
                            extra="mb-3 w-80 mr-5"
                            label="Rating by user"
                            placeholder="Rating by user"
                            id="providerRating"
                            type="number"
