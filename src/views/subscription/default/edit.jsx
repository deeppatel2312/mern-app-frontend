...
const SubscriptionEdit = () => {
    ...
    const loadSubscription = async () => {
        ...
        setIsLoading(true);
        let results = await fetch(`${process.env.REACT_APP_API_URL}/api/subscription/findById`, {
            method: 'POST',
            headers: {
    ...
    const editUser = async () => {
        ...
        setIsLoading(true);
        const token = localStorage.getItem('LuminixLoginToken');
        let results = await fetch(`${process.env.REACT_APP_API_URL}/api/subscription/update`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}`
                ...
                <div className="w-full max-w-full flex-col items-center xl:max-w-[1120px] border border-gray-400 p-8 rounded-[8px] block">
                    ...
                    <div className="flex justify-between flex-wrap">
                        ...
                        <TextareaField
                            ...
                            id='description'
                            extra='mb-3 w-80 mr-4'
                            placeholder='Each line should be comma separated.'
                            cols={20}
                            rows={2}
                            state=''
                            disabled={false}
