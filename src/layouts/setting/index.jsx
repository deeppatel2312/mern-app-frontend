...
export default function Setting(props) {
    ...
    const [currentRoute, setCurrentRoute] = React.useState("Setting Dashboard");
    ...
    const getActiveRoute = (routes) => {
        let activeRoute = "Setting Dashboard";
                    ...
                    <div className="h-full">
                        ...
                        <div className="pt-5s mx-auto mb-auto h-full min-h-[84vh] p-2 md:pr-2">
                            <Routes>
                                ...
                                <Route
                                    path="/"
                                    element={<Navigate to="/setting/default" replace />}
                                />
                            </Routes>
                        </div>
                        {/* <div className="p-3">
