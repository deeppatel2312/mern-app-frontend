...
import SubscriptionCreate from "views/subscription/default/create";
import SubscriptionEdit from "views/subscription/default/edit";
        ...
        return routes.map((prop, key) => {
            if (prop.layout === "/subscription") {
                ...
                return prop.child.map((childProp, childKey) => {
                    if (childProp.layout === "/subscription") {
                    ...
                    <div className="h-full">
                        ...
                        <div className="pt-5s mx-auto mb-auto h-full min-h-[84vh] p-2 md:pr-2">
                            <Routes>
                                ...
                                <Route
                                    path="/"
                                    element={<Navigate to="/subscription/default" replace />}
                                />
                                <Route
                                    path="/edit"
