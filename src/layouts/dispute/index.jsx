...
import DisputeEdit from "views/dispute/default/edit";
import DisputeCreate from "views/dispute/default/create";
                    ...
                    <div className="h-full">
                        ...
                        <div className="pt-5s mx-auto mb-auto h-full min-h-[84vh] p-2 md:pr-2">
                            <Routes>
                                ...
                                <Route
                                    path="/"
                                    element={<Navigate to="/dispute/default" replace />}
                                />
                                <Route
                                    path="/edit"
                                    element={<DisputeEdit />}
