...
// import ReviewEdit from "views/reviewManagement/default/edit";
import ReviewUserEdit from "views/reviewManagementUser/default/edit";

export default function Review(props) {
    const { ...rest } = props;
    const location = useLocation();
    const [open, setOpen] = React.useState(true);
    const [currentRoute, setCurrentRoute] = React.useState("Review Dashboard");
    ...
    const getActiveRoute = (routes) => {
        let activeRoute = "Review Dashboard";
        ...
        return routes.map((prop, key) => {
            if (prop.layout === "/reviewUser") {
                ...
                return prop.child.map((childProp, childKey) => {
                    if (childProp.layout === "/reviewUser") {
                    ...
                    <div className="h-full">
                        ...
                        <div className="pt-5s mx-auto mb-auto h-full min-h-[84vh] p-2 md:pr-2">
                            <Routes>
                                ...
                                <Route
                                    path="/"
                                    element={<Navigate to="/reviewUser/default" replace />}
                                />
                                <Route
                                    path="/edit"
                                    element={<ReviewUserEdit />}
                                />
                            </Routes>
                        </div>
                        {/* <div className="p-3">
