...
import ProviderEdit from "views/provider/default/edit";
import ProviderCreate from "views/provider/default/create";
                    ...
                    <div className="h-full">
                        ...
                        <div className="pt-5s mx-auto mb-auto h-full min-h-[84vh] p-2 md:pr-2">
                            <Routes>
                                ...
                                <Route
                                    path="/"
                                    element={<Navigate to="/provider/default" replace />}
                                />
                                <Route
                                    path="/edit"
